    ...
    <body id="page-top">
        ...
        <header class="bg-primary bg-gradient text-white mt-3 pt-5 pb-2">
            <div class="container px-4 text-center">
                <h1 class="fw-bolder">Editando o telefone de: {{ $aluno->nome }}</h1>
        ...
        <section id="about" class="p-2 m-2">
            <div class="container px-4">
                ...
                <form class="mt-3" action="{{ route('telefones.update', [$telefone->id]) }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="aluno_id" id="aluno_id" placeholder="Aluno" value="{{ $telefone->aluno_id }}">
